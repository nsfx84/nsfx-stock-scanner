// S&P 500 constituent tickers (snapshot - rebuild periodically).
// Source: Wikipedia "List of S&P 500 companies"
// To refresh: run `node scripts/refresh-universes.js` (see scripts/ folder).
...
export const UNIVERSES = {
  sp500: { label: 'S&P 500', tickers: SP500 },
  nasdaq100: { label: 'NASDAQ 100', tickers: NASDAQ100 }
}
